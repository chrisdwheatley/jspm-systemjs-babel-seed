...
(function(process) {
  !function(undefined) {
    ...
    (function(modules) {
      ...
      var $def = __webpack_require__(58);
      $def($def.P, 'String', {codePointAt: __webpack_require__(69)(false)});
    }, function(module, exports, __webpack_require__) {
      'use strict';
      var $ = __webpack_require__(56),
          cof = __webpack_require__(57),
      ...
      var $def = __webpack_require__(58);
      $def($def.P, 'Array', {find: __webpack_require__(60)(5)});
      __webpack_require__(73)('find');
    }, function(module, exports, __webpack_require__) {
      var $def = __webpack_require__(58);
      $def($def.P, 'Array', {findIndex: __webpack_require__(60)(6)});
      ...
      var $def = __webpack_require__(58);
      $def($def.P, 'Array', {includes: __webpack_require__(63)(true)});
      __webpack_require__(73)('includes');
    }, function(module, exports, __webpack_require__) {
      var $def = __webpack_require__(58);
      $def($def.P, 'String', {at: __webpack_require__(69)(true)});
    }, function(module, exports, __webpack_require__) {
      var $def = __webpack_require__(58);
      $def($def.S, 'RegExp', {escape: __webpack_require__(64)(/([\\\-[\]{}()*+?.,^$|])/g, '\\$1', true)});
    }, function(module, exports, __webpack_require__) {
      var $ = __webpack_require__(56),
          $def = __webpack_require__(58),
          ownKeys = __webpack_require__(79);
      ...
      function setStatics(keys, length) {
        $.each.call(keys.split(','), function(key) {
          if (length == undefined && key in $Array)
            ...
            statics[key] = __webpack_require__(71)(Function.call, [][key], length);
        });
      }
      ...
      module.exports = function(name) {
        return store[name] || (store[name] = global.Symbol && global.Symbol[name] || __webpack_require__(61).safe('Symbol.' + name));
      };
    }, function(module, exports, __webpack_require__) {
      var $ = __webpack_require__(56);
      ...
      module.exports = function(C) {
        if ($.DESC && $.FW)
          $.setDesc(C, __webpack_require__(66)('species'), {
            configurable: true,
            get: $.that
          });
      };
      ...
      module.exports = function(NAME, methods, common, IS_MAP, isWeak) {
        ...
        if (!$.isFunction(C) || !(isWeak || !$iter.BUGGY && proto.forEach && proto.entries)) {
          ...
          var inst = new C,
              ...
              buggyZero;
          if (!__webpack_require__(72)(function(iter) {
            new C(iter);
          })) {
            C = function(iterable) {
